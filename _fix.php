    ...
    public function printLabel(Request $request)
    {
        ...
        if (count($barang) > $sisaSlot) {
            return response()->json([
                'message' => 'Posisi mulai melebihi sisa slot yang tersedia.'
            ], 422);
        }
...
file_put_contents('app/Http/Controllers/BarangController.php', $content);
echo 'Done: ' . strlen($content) . ' bytes written';
