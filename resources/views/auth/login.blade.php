...
<body>
                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <form class="pt-3" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mt-3">
                                    <button type="button" id="btn-login" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" onclick="submitLoginWithSpinner(this)">SIGN IN</button>
                                </div>
                            ...
                            {{-- Google Login Button - DI BAWAH SIGN IN --}}
                            <div>
                                <a href="{{ route('auth.google') }}" class="btn btn-block btn-lg btn-google" id="btn-google" onclick="googleLoginSpinner(this)">
    ...
    <script>
        function submitLoginWithSpinner(btn) {
        ...
        function googleLoginSpinner(link) {
            link.classList.add('disabled');
            link.innerHTML = '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Redirecting...';
        }
    </script>
</body>
</html>