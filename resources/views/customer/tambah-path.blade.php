...
@section('title', 'Tambah Customer (Path)')
@section('icon', 'mdi-account-plus')

@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
<li class="breadcrumb-item"><a href="{{ route('customer.index') }}">Customer</a></li>
<li class="breadcrumb-item active">Tambah (Path)</li>
@endsection
...
<div class="row">
    <div class="col-md-6 grid-margin stretch-card mx-auto">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Form Tambah Customer (Foto via Kamera → Path)</h4>
                <p class="card-description">Data foto akan disimpan di folder Storage dan alamat file direkam ke database.</p>
                <form action="{{ route('customer.storePath') }}" method="POST" class="forms-sample">
                    @csrf
