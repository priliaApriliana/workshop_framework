...
@section('title', 'Tambah Menu Vendor')
@section('icon', 'mdi-plus-box')
...
<div class="row">
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Form Tambah Menu
                    @if($myVendor)
                ...
                <form action="{{ route('vendor.menu.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_vendor" class="form-control" required>
                                ...
                                @foreach($vendors as $vendor)
                                    <option value="{{ $vendor->id_vendor }}" {{ old('id_vendor') == $vendor->id_vendor ? 'selected' : '' }}>
                                        {{ $vendor->nama_vendor }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        <label>Harga</label>
                        <input type="number" name="harga" class="form-control" value="{{ old('harga') }}" required min="1000">
                    </div>
